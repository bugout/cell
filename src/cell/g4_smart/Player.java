package cell.g4_smart;

import java.util.Arrays;
import java.util.Random;

import cell.g4_smart.movement.MoveAlgo;
import cell.g4_smart.movement.ShortestPathMove;
import cell.g4_smart.trade.MaxRateDiffTrade;
import cell.g4_smart.trade.MergeTrade;
import cell.g4_smart.trade.TradeAlgo;
...
public class Player implements cell.sim.Player {
	...
	@Override
	public String name() {
		return "G4 Player smart" + (versions > 1 ? " v" + version : "");
	}
}