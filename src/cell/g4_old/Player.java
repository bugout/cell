...
import cell.g4_old.movement.MoveAlgo;
import cell.g4_old.movement.ShortestPathMove;
import cell.g4_old.trade.MaxRateDiffTrade;
import cell.g4_old.trade.MergeTrade;
import cell.g4_old.trade.TradeAlgo;
...
public class Player implements cell.sim.Player {
	...
	@Override
	public String name() {
		return "G4 Player old" + (versions > 1 ? " v" + version : "");
	}
}